...
const choice_1 = new Drink("Espresso", choice_1_desc, imgURL_1, "$3.99");
const choice_2 = new Drink("Vietnamese Drip Coffee", choice_2_desc, imgURL_2, "$4.99");
const choice_3 = new Drink("Coffee with Condensed Milk", choice_3_desc, imgURL_3, "$5.99");
const choice_4 = new Drink("Latte", choice_4_desc, imgURL_4, "$3.99");
const choice_5 = new Drink("Egg Coffee", choice_5_desc, imgURL_5, "$5.99");
const choice_6 = new Drink("Coconut Coffee", choice_6_desc, imgURL_6, "$4.99");
